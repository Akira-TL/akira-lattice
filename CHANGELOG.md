...
- 为 Akira Research 的 Communication 增加写作类型路由：长篇正文开始前先区分原始研究论文、普通叙述性综述和系统综述/范围综述/荟萃分析；普通综述按 Review Question / Scope、材料盘点、主题分类、跨论文综合、理论/概念框架、真实研究缺口与 future direction 组织，不再套用原始研究论文的 Results / Discussion 流程。正式证据综合研究若检索、筛选、质量评价、数据提取与综合 provenance 未完成，则返回科研流程而不是直接写稿。
